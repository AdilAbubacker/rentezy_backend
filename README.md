...
> *A fully distributed, event-driven, microservices-based platform automating entire property rental lifecycle from property discovery and visit scheduling to rent collection and communication. Engineered to handle race conditions, distributed transactions, and automated rent billing using Kafka, Celery, and Kubernetes.*
